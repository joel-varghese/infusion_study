...
class ModelBatcher:
  ...
  mae, rmse, mape  = trainerclass.train_model(feature_size=6, hidden_dim=Config.hidden_dim, num_layers=Config.num_layers,
                  nheads=Config.nhead, dropout=Config.dropout, weight_decay=1e-4, epochs=Config.epochs, seed=42,
                  window_size=Config.window_size, prediction_length=Config.prediction_length, device=device, model_path='model_weights.pth')
